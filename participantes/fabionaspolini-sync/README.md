...
- `dotnet 8` para API com:
  ...
  - Esta versão não utiliza async/await, o objetivo é validar se a redução de troca de contextos das threads do sistema operacional apresentarão mudaça significativa de latência e consumo de hardware.
