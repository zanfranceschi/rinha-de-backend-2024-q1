...
create table "transactions" ("id" serial not null primary key, "client_id" integer not null, "valor" integer not null, "tipo" varchar(1) not null, "descricao" varchar(10) not null, "realizada_em" varchar(255) not null);
